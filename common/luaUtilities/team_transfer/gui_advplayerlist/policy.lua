...
function PolicyHelpers.GetPlayerResourcePolicy(player, resourceType, senderTeamId)
  local policyType = resourceType == "metal" and TransferEnums.PolicyType.MetalTransfer or
      TransferEnums.PolicyType.EnergyTransfer
...
function PolicyHelpers.UnpackAllPolicies(playerData, myTeamID, team)
  local metalPolicy = PolicyHelpers.UnpackPolicyResult(TransferEnums.PolicyType.MetalTransfer, playerData, myTeamID,
      team)
  local energyPolicy = PolicyHelpers.UnpackPolicyResult(TransferEnums.PolicyType.EnergyTransfer, playerData, myTeamID,
      team)
...
function PolicyHelpers.UnpackUnitPolicyResult(playerData, senderTeamId, receiverTeamId)
  return PolicyHelpers.UnpackPolicyResult(TransferEnums.PolicyType.UnitTransfer, playerData, senderTeamId,
    receiverTeamId)
end
